    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                .pathBuilder()
                .addPath(
                    new BezierLine(new Pose(116.000, 132.000), new Pose(88.000, 96.000))
                )
            ...
            Path3 = follower
                .pathBuilder()
                .addPath(
                    new BezierLine(new Pose(106.500, 84.000), new Pose(114.000, 84.000))
                )
            ...
            Path4 = follower
                .pathBuilder()
                .addPath(
                    new BezierLine(new Pose(111.500, 84.000), new Pose(116.500, 84.000))
                )
                .setTangentHeadingInterpolation()
                .build();
            ...
            Path5 = follower
                .pathBuilder()
                .addPath(
                    new BezierLine(new Pose(116.500, 84.000), new Pose(121.500, 84.000))
                )
                .setTangentHeadingInterpolation()
                .build();
            ...
            Path6 = follower
                .pathBuilder()
                .addPath(
                    new BezierLine(new Pose(121.500, 84.000), new Pose(88.000, 96.000))
                )
